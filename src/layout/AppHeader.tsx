...
const AppHeader: React.FC = () => {
  ...
  return (
    <header className="sticky top-0 flex w-full bg-gradient-to-r from-blue-700 via-blue-800 to-blue-900 border-gray-200 dark:border-gray-800 dark:bg-gray-900 lg:border-b z-999 shadow-lg">
      <div className="flex flex-col items-center justify-between grow lg:flex-row lg:px-6 z-999">
        <div className="flex items-center justify-between w-full gap-2 px-3 py-3 border-b border-gray-200 dark:border-gray-800 sm:gap-4 lg:justify-normal lg:border-b-0 lg:px-0 lg:py-4">
          {/* Only show sidebar toggle button if category_id is not 32, 24, 35, 4 or 8 */}
          {categoryId !== "32" && categoryId !== "24" && categoryId !== "35" && categoryId !== "4" && categoryId !== "8" && (
            <button
        ...
        >
          <div className="flex items-center gap-2 2xsm:gap-3">
            ...
            <div className="relative">
              ...
              {isNotificationOpen && (
                <div className="absolute -right-[240px] mt-[17px] flex h-[480px] w-[350px] flex-col rounded-2xl border border-gray-200 bg-white p-3 shadow-theme-lg dark:border-gray-800 dark:bg-gray-dark sm:w-[361px] lg:right-5 z-50">
