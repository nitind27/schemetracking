...
async function getData(): Promise<{
  ...
  const [farmersRes, villagesRes, talukaRes, schemesRes] = await Promise.all([
  ...
  const [farmers, villages, talukas, schemes] = await Promise.all([
    farmersRes.json(),
    villagesRes.json(),
    talukaRes.json(),
    schemesRes.json(),
  ...
  return { farmers, villages, talukas, schemes };
}
...
const Page = async () => {
  ...
  const { farmers, villages, talukas, schemes } = await getData();
